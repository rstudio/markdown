...
| Phones and tablets  | \< 992px | Document |   100%    |       N/A        |
...
-   I developed the [xaringan](https://github.com/yihui/xaringan) in package
    2016 (based on the JS library `remark.js`) and have used it since then. It
    still works perfectly, but now I prefer more lightweight frameworks.

-   Most of presentation features that I need are included in
    `r length(xfun::read_all(pres_files))` lines of JS/CSS code
    (`snap.js`/`.css`).

-   This simple presentation framework is highly customizable.

-   If you know HTML/CSS/JS, you can be addicted to customizing your slides.
