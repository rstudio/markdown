...
By default, all sections are numbered. If you do not want the numbers, you can
hide them via CSS:
...
For this presentation, section numbers for second-level headers are displayed:
...
Or shorten TOC (hide lower-level headers):
...
For this presentation, we don't hide lower-level headers in TOC but just make
